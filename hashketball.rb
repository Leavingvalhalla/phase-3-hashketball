...
all_teams.find {|team| team[:team_name] == team_name}[:colors]
end
...
def player_numbers (team_name)
  target = all_teams.find {|team| team[:team_name] == team_name}
  target[:players].map {|player| player[:number]}
end
